...
public class NewCustomer extends JFrame {
	...
	public NewCustomer() throws SQLException {
                ...
                setBounds(200, 120, 850, 550);
		contentPane = new JPanel();
		setContentPane(contentPane);
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("tourism/offices/system/icons/fifth.png"));
		...
		JLabel lblName = new JLabel("BOOKING FORM");
		...
		contentPane.add(lblId);
                ...
                comboBox = new JComboBox(new String[] {"Passport", "Military Id", "National Id", "Driving license"});
		...
		JLabel lblReserveRoomNumber = new JLabel("Allocated Hotel :");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s7 =  t5.getText();
                                ...
                                /*String rooms = "select rooms from hotels where hotel_name = "+s6;
                                
                                int i = Integer.parseInt(rooms);
                                int res = i-1;
                                String rms = String.valueOf(res);
                                String q2 = "Update hotels set rooms = rms where hotel_name = "+s6;
                                */
